...
class ImageOnlyCheckpointLoader:
    ...
    def load_checkpoint(self, ckpt_name, output_vae=True, output_clip=True):
        ...
        out = comfy.sd.load_checkpoint_guess_config(
            ckpt_path, output_vae=True, output_clip=False, output_clipvision=True, embedding_directory=folder_paths.get_folder_paths("embeddings")
        )
...
class ImageOnlyCheckpointSave(comfy_extras.nodes_model_merging.CheckpointSave):
    ...
    def save(self, model, clip_vision, vae, filename_prefix, prompt=None, extra_pnginfo=None):
        comfy_extras.nodes_model_merging.save_checkpoint(
            model, clip_vision=clip_vision, vae=vae, filename_prefix=filename_prefix, output_dir=self.output_dir, prompt=prompt, extra_pnginfo=extra_pnginfo
        )
        return {}
